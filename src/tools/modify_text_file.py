...
class TextFileModifierTool(BaseTool):
    ...
    description: str = (
        ...
        "ALWAYS target only the exact lines that need changing — "
        "never rewrite the whole file unless strictly necessary. "
        "Preserve original formatting — do not add extra blank lines."
    )
    emitter: Any = None
